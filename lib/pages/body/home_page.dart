...
class _HomePageState extends State<HomePage>
  ...
  Future<void> fetchNewArrivalProducts() async {
    ...
    final url =
        Uri.parse("https://ib.jamalmoallart.com/api/v2/new_arrival_products");
                ...
                leading: InkWell(
                  child: Padding(
                    ...
                    child: ProfilePicture(
                        name: "$firstName $lastName", radius: 5, fontsize: 20),
                  ),
                  onTap: () {},
                ),
                title: Text(
                ...
                actions: [
                  IconButton(
                      onPressed: () {
                        showSearch(
                            context: context,
                            delegate: MySearchDelegate(/*newArrivalProducts*/));
                      },
            ...
            : Padding(
                ...
                child: GridView.builder(
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      mainAxisSpacing: 10,
                      mainAxisExtent:
                          AppScreenSize.getScreenHeight(context) * .3),
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => ProductDetailsScreen(
                                  id: newArrivalProducts[index]["id"])));
                    },
                  ),
                ),
              ));
